...
Route::group(['prefix' => 'v1','namespace' => 'Api', 'middleware' => 'auth:api'], function () {
    ...
    // /*--- Land API ---*/
    // Route::get('land/selectlist',
    //     [
    //         'as' => 'api.land.selectlist',
    //         'uses'=> 'LandController@selectlist'
    //     ]
    // );
    ...
    //         'names' =>
    //             [
    //                 'index' => 'api.land.index',
    //                 'show' => 'api.land.show',
    //                 'store' => 'api.land.store',
    //                 'update' => 'api.land.update',
    //                 'destroy' => 'api.land.destroy'
    //             ],
    //         'except' => ['create', 'edit'],
    ...
    //     Route::get('view/{id}/users',
    //         [
    //             'as' => 'api.land.showUsers',
    //             'uses' => 'LandController@getDataView'
    //         ]
    //     );

    //     Route::post('{land}/checkout',
    //         [
    //             'as' => 'api.lands.checkout',
    //             'uses' => 'LandController@checkout'
    //         ]
    //     );
    // }); // Land group

    // /*--- Building API ---*/
    // Route::get('buildings/selectlist',
    //     [
    //         'as' => 'api.buildings.selectlist',
    //         'uses'=> 'BuildingsController@selectlist'
    //     ]
    // );
    ...
    //     Route::post('{building}/checkout',
    //         [
    //             'as' => 'api.buildings.checkout',
    //             'uses' => 'BuildingsController@checkout'
    //         ]
    //     );
    // }); // Buildings group
